...
class Widget_Users_Profile extends Widget_Users_Edit implements Widget_Interface_Do
{
    ...
    public function profileForm()
    {
        ...
        /** 用户昵称 */
        $screenName = new Typecho_Widget_Helper_Form_Element_Text('screenName', null, null, _t('昵称'), _t('用户昵称可以与用户名不同, 用于前台显示.如果你将此项留空, 将默认使用用户名.'));
        ...
        /** 电子邮箱地址 */
        $mail = new Typecho_Widget_Helper_Form_Element_Text('mail', null, null, _t('电子邮箱地址 *'), _t('电子邮箱地址将作为此用户的主要联系方式.请不要与系统中现有的电子邮箱地址重复.'));
        $form->addInput($mail);
    ...
    public function optionsForm()
    {
        ...
        $markdown = new Typecho_Widget_Helper_Form_Element_Radio('markdown',
            ...
            _t('使用 <a href="http://daringfireball.net/projects/markdown/">Markdown</a> 语法能够使您的撰写过程更加简便直观。此功能开启不会影响以前没有使用 Markdown 语法编辑的内容.'));
